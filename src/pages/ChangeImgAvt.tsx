...
const ChangeImgAvt: React.FC = () => {
    ...
    const handleSubmit = () => {
        ...
        if (avatar) {
            ...
            formData.append("images1", avatar);
            formData.append("title", "1233212131321");
    
            axios.post('https://project-ltw-final.onrender.com/chat-app/imageupload1/', formData, config,)
                .then((res) => {
