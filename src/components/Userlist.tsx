                        ...
                        <div className="shadow overflow-hidden">
                            <table className="table-fixed min-w-full divide-y divide-gray-200 border-collapse border border-slate-200 ">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {searchItems && searchItems.map((el: any, index: any) => (
                                        <tr className="hover:bg-gray-100" key={index}>
                                            <td className="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                {/* <img className="h-10 w-10 rounded-full" src={el.avt} alt={`${el.name} avatar`}/> */}
                                                <img className="h-10 w-10 rounded-full" src={el.photo} alt={`${el.name} avatar`}/>
                                            ...
                                            <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">{el.position}</td>
